...
const ImportPlanModal = dynamic(() =>
  import('../components/modals/ImportPlanModal').then((m) => m.ImportPlanModal)
);
...
const AddProjectModal = dynamic(
  () => import('../components/modals/AddProjectModal')
);
const AddAgentModal = dynamic(
  () => import('../components/modals/AddAgentModal')
);
const DevToolsDrawer = dynamic(
  () => import('../components/modals/DevToolsDrawer')
);
