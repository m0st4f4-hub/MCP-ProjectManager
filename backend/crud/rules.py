...
"""
    ...
    # TODO: Include information about available memory tools and their usage here.
    # This could be dynamically generated based on the memory tools available via fastapi-mcp.
    prompt += f"\n## Available Memory Tools\nYou have access to the following memory tools:\n"
    # Example: Iterate through available memory tools and add their descriptions
    # for tool in get_available_memory_tools(): # Hypothetical function
