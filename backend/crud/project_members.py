...
from sqlalchemy import and_, select, delete, update # Import necessary for async operations
...
# Assuming member_exists is now async or will be awaited appropriately where called
...
async def add_project_member(db: AsyncSession, project_member: ProjectMemberCreate) -> ProjectMember:
 ...
 # Assuming member_exists is async or will be awaited where called
