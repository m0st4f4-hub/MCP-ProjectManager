...
async def get_all_tasks(
 ...
 if agent_name:
 # Handle agent_name filtering by joining with the agents table
 if agent_name:
 query = query.join(models.Agent, models.Task.agent_id == models.Agent.id).filter(
 models.Agent.name.ilike(f"%{agent_name}%")
 )
 ...
 # Default sort by created_at descending if sort_by is invalid or not provided
