...
# You might also need schemas for relationships if MemoryEntities link to other entities
# class MemoryRelationshipCreate(BaseModel):
#     source_entity_id: int
#     target_entity_id: int
#     relationship_type: str # e.g., "mentions", "relates_to"
