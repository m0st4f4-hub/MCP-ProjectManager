...
from backend.schemas.project_template import ProjectTemplate, ProjectTemplateCreate, ProjectTemplateUpdate

# Import auth dependencies and UserRoleEnum for protection
...
router = APIRouter(
    ...
    # Protect all template management endpoints, maybe ADMIN only?
...
def create_project_template(
    ...
    """
    # Optional: Add role check here if only certain roles can create templates
    # E.g., Depends(RoleChecker([UserRoleEnum.ADMIN]))
