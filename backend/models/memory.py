...
class MemoryEntity(Base):
    ...
    updated_at: Mapped[Optional[datetime]] = mapped_column(DateTime, default=lambda: datetime.now(UTC), onupdate=lambda: datetime.now(UTC), nullable=True)
    ...
    relations_as_to: Mapped[List["MemoryRelation"]] = relationship(
        ...
        back_populates="to_entity")  # Add relationships back to file association models  # This matches ProjectFileAssociation.file_entity (back_populates)
