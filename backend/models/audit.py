...
class AgentBehaviorLog(Base, BaseModel):
 ...
 primaryjoin="and_(AgentBehaviorLog.task_project_id == Task.project_id, AgentBehaviorLog.task_task_number == Task.task_number)"
 )
...
class AgentRuleViolation(Base, BaseModel):
 ...
 "Task",
 foreign_keys=[task_project_id, task_task_number],
 primaryjoin="and_(AgentRuleViolation.task_project_id == Task.project_id, AgentRuleViolation.task_task_number == Task.task_number)"
 )
