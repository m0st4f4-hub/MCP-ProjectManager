...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_project_templates_id'),
                    'project_templates', ['id'], unique=False)
    op.create_index(op.f('ix_project_templates_name'),
                    'project_templates', ['name'], unique=True)
    ...
    op.create_index(op.f('ix_task_statuses_order'),
                    'task_statuses', ['order'], unique=True)
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('TO_DO', 'IN_PROGRESS', 'UNDER_REVIEW',
                  'DONE', 'BLOCKED', name='taskstatusenum'), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.Column('is_archived', sa.Boolean(), nullable=False),
    ...
    op.create_index(
        op.f('ix_agent_behavior_logs_agent_name'),
        'agent_behavior_logs',
        ['agent_name'],
        unique=False,
    )
    op.create_index(
        op.f('ix_agent_behavior_logs_id'),
        'agent_behavior_logs',
        ['id'],
        unique=False,
    )
    ...
    op.create_index(op.f('ix_universal_mandates_id'),
                    'universal_mandates', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(
        ...
        table_name='universal_mandates',
    )
    op.drop_table('universal_mandates')

    op.drop_index(
        op.f('ix_agent_rule_violations_id'),
        table_name='agent_rule_violations',
    )
    op.drop_index(
        op.f('ix_agent_rule_violations_agent_name'),
        table_name='agent_rule_violations',
    )
    ...
    op.drop_index(
        op.f('ix_memory_relations_relation_type'),
        table_name='memory_relations',
    )
    op.drop_index(
        op.f('ix_memory_relations_id'),
        table_name='memory_relations',
    )
    op.drop_table('memory_relations')

    op.drop_index(
        op.f('ix_memory_observations_id'),
        table_name='memory_observations',
    )
    op.drop_table('memory_observations')

    op.drop_index(
        op.f('ix_memory_entities_id'),
        table_name='memory_entities',
    )
    op.drop_index(
        op.f('ix_memory_entities_entity_type'),
        table_name='memory_entities',
    )
    ...
    op.drop_index(
        op.f('ix_project_templates_name'),
        table_name='project_templates',
    )
    op.drop_index(
        op.f('ix_project_templates_id'),
        table_name='project_templates',
    )
