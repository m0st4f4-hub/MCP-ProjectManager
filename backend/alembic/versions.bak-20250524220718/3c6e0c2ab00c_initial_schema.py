...
def upgrade() -> None:
    ...
    op.create_table('universal_mandates',
    sa.Column('id', sa.String(length=32), nullable=False),
    ...
    op.create_table('agent_error_protocols',
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.Column('agent_role_id', sa.String(length=32), nullable=False),
    ...
    op.create_table('agent_forbidden_actions',
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.Column('agent_role_id', sa.String(length=32), nullable=False),
    ...
    op.create_table('agent_handoff_criteria',
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.Column('agent_role_id', sa.String(length=32), nullable=False),
    ...
    op.create_table('agent_behavior_logs',
    sa.Column('id', sa.String(length=32), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['agent_role_id'], ['agent_roles.id'], ),
    sa.ForeignKeyConstraint(['task_project_id'], ['tasks.project_id'], ),
    sa.ForeignKeyConstraint(['task_task_number'], ['tasks.task_number'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('agent_rule_violations',
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.Column('agent_name', sa.String(length=100), nullable=False),
    sa.Column('agent_role_id', sa.String(length=32), nullable=True),
    ...
    op.create_table('task_file_associations',
    sa.Column('id', sa.String(length=32), nullable=False),
    ...
    op.create_index(op.f('ix_task_file_associations_file_memory_entity_id'), 'task_file_associations', ['file_memory_entity_id'], unique=False)
