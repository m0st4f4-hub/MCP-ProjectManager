...
def test_create_and_get_task_file_association(db_session: Session):
    ...
    dummy_entity_1 = memory_crud.create_memory_entity(db_session, schemas.MemoryEntityCreate(id=file_memory_entity_id_1, type="file", name=f"file_{file_memory_entity_id_1}", description="", metadata_={}))
    dummy_entity_2 = memory_crud.create_memory_entity(db_session, schemas.MemoryEntityCreate(id=file_memory_entity_id_2, type="file", name=f"file_{file_memory_entity_id_2}", description="", metadata_={}))

    # Associate file 1
    association_data_1 = schemas.TaskFileAssociationCreate(
    ...
    # Associate file 2
    association_data_2 = schemas.TaskFileAssociationCreate(
        task_project_id=str(task.project_id),
        task_task_number=task.task_number,
...
def test_get_files_for_task(db_session: Session):
    ...
    dummy_entity_a = memory_crud.create_memory_entity(db_session, schemas.MemoryEntityCreate(id=file_memory_entity_id_a, type="file", name=f"file_{file_memory_entity_id_a}", description="", metadata_={}))
    dummy_entity_b = memory_crud.create_memory_entity(db_session, schemas.MemoryEntityCreate(id=file_memory_entity_id_b, type="file", name=f"file_{file_memory_entity_id_b}", description="", metadata_={}))
    dummy_entity_c = memory_crud.create_memory_entity(db_session, schemas.MemoryEntityCreate(id=file_memory_entity_id_c, type="file", name=f"file_{file_memory_entity_id_c}", description="", metadata_={}))
