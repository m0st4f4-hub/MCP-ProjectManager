...
from backend.schemas.user import User, UserRole # Assuming User and UserRole models exist
from backend.models.project import Project as ProjectModel # Import SQLAlchemy model for type hinting mock returns
from backend.models.user import User as UserModel # Import SQLAlchemy model for type hinting
from backend.models.audit import AuditLog as AuditLogModel # Import AuditLogModel
from backend.services import project_service

# Import authentication dependencies and utilities
from backend.auth import get_current_active_user, RoleChecker
from backend.enums import UserRoleEnum # Assuming UserRoleEnum is defined here or imported
...
from backend.database import get_db # Import the actual get_db
...
def mock_audit_log_service_instance():
    ...
    from backend.services.audit_log_service import AuditLogService # Correct import
...
async def test_create_project_success(
    ...
    mock_project_return_object.created_at = datetime.utcnow() # Use utcnow for timezone-naive if needed, or prefer timezone-aware
    mock_project_return_object.updated_at = datetime.utcnow()
    ...
    mock_project_return_object.last_activity_at = datetime.utcnow()
...
async def test_update_project_success(
    ...
    mock_updated_project_object.created_at = datetime.utcnow() # Simulate datetime object
    mock_updated_project_object.updated_at = datetime.utcnow() # Simulate datetime object
    ...
    mock_updated_project_object.last_activity_at = datetime.utcnow()
