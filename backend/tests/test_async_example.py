...
# Import models
from .models import Project, Task, Agent, User
...
class TestProjectsCRUD:
 ...
 @pytest.mark.asyncio
 async def test_get_project_by_name_not_found(self, async_db_session: AsyncSession):
 """Test retrieving a non-existent project by name."""
 # Try to get a project with a fake name
 project = await crud_projects.get_project_by_name(
 db=async_db_session,
